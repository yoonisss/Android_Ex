...
import com.example.ch18_net_test1.model.Item
...
class MyAdapter(val context: Context, val datas: MutableList<Item>?): RecyclerView.Adapter<RecyclerView.ViewHolder>(){
